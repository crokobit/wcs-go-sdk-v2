...
const (
	wosSdkVersion          = "3.21.1"
	USER_AGENT             = "wos-sdk-go/" + wosSdkVersion
	HEADER_PREFIX          = "x-amz-"
	HEADER_PREFIX_META     = "x-amz-meta-"
	HEADER_PREFIX_WOS      = "x-wos-"
	HEADER_PREFIX_META_WOS = "x-wos-meta-"
	HEADER_DATE_AMZ        = "x-amz-date"
	HEADER_DATE_WOS        = "x-wos-date"
	HEADER_STS_TOKEN_AMZ   = "x-amz-security-token"
	HEADER_STS_TOKEN_WOS   = "x-wos-security-token"
	HEADER_ACCESSS_KEY_AMZ = "AWSAccessKeyId"
	PREFIX_META            = "meta-"

	HEADER_CONTENT_SHA256_AMZ               = "x-amz-content-sha256"
	HEADER_CONTENT_SHA256_WOS               = "x-wos-content-sha256"
	HEADER_ACL_AMZ                          = "x-amz-acl"
	HEADER_ACL_WOS                          = "x-wos-acl"
	HEADER_ACL                              = "acl"
	HEADER_LOCATION_AMZ                     = "location"
	HEADER_BUCKET_LOCATION_WOS              = "bucket-location"
	HEADER_COPY_SOURCE                      = "copy-source"
	HEADER_COPY_SOURCE_RANGE                = "copy-source-range"
	HEADER_RANGE                            = "Range"
	HEADER_STORAGE_CLASS                    = "x-default-storage-class"
	HEADER_STORAGE_CLASS_WOS                = "x-wos-storage-class"
	HEADER_VERSION_WOS                      = "version"
	HEADER_GRANT_READ_WOS                   = "grant-read"
	HEADER_GRANT_WRITE_WOS                  = "grant-write"
	HEADER_GRANT_READ_ACP_WOS               = "grant-read-acp"
	HEADER_GRANT_WRITE_ACP_WOS              = "grant-write-acp"
	HEADER_GRANT_FULL_CONTROL_WOS           = "grant-full-control"
	HEADER_GRANT_READ_DELIVERED_WOS         = "grant-read-delivered"
	HEADER_GRANT_FULL_CONTROL_DELIVERED_WOS = "grant-full-control-delivered"
	...
	HEADER_EXPIRES_WOS                      = "x-wos-expires"
	...
	HEADER_SSEKMS_ENCRYPT_KEY_WOS = "server-side-encryption-kms-key-id"
	...
	HEADER_SSEKMS_KEY_WOS = "x-wos-server-side-encryption-kms-key-id"
	...
	PARAM_ALGORITHM_WOS_CAMEL     = "X-Wos-Algorithm"
	PARAM_CREDENTIAL_AMZ_CAMEL    = "X-Amz-Credential"
	PARAM_CREDENTIAL_WOS_CAMEL    = "X-Wos-Credential"
	PARAM_DATE_AMZ_CAMEL          = "X-Amz-Date"
	PARAM_DATE_WOS_CAMEL          = "X-Wos-Date"
	PARAM_EXPIRES_AMZ_CAMEL       = "X-Amz-Expires"
	PARAM_EXPIRES_WOS_CAMEL       = "X-Wos-Expires"
	PARAM_SIGNEDHEADERS_AMZ_CAMEL = "X-Amz-SignedHeaders"
	PARAM_SIGNEDHEADERS_WOS_CAMEL = "X-Wos-SignedHeaders"
	PARAM_SIGNATURE_AMZ_CAMEL     = "X-Amz-Signature"
	PARAM_SIGNATURE_WOS_CAMEL     = "X-Wos-Signature"

	DEFAULT_SIGNATURE            = SignatureWos
	...
	V4_SERVICE_NAME       = "s3"
	V4_WOS_SERVICE_NAME   = "wos"
	V4_SERVICE_SUFFIX     = "aws4_request"
	V4_WOS_SERVICE_SUFFIX = "wos_request"

	V2_HASH_PREFIX  = "AWS"
	WOS_HASH_PREFIX = "WOS"

	V4_HASH_PREFIX     = "AWS4-HMAC-SHA256"
	V4_WOS_HASH_PREFIX = "WOS-HMAC-SHA256"
	V4_HASH_PRE        = "AWS4"
	V4_WOS_HASH_PRE    = "WOS"

	DEFAULT_SSE_KMS_ENCRYPTION     = "aws:kms"
	DEFAULT_SSE_KMS_ENCRYPTION_WOS = "kms"
...
const (
	...
	// SignatureWos signature type WOS
	SignatureWos SignatureType = "WOS"
)
...
const (
	...
	SubResourceAvinfo SubResourceType = "avinfo"
)
...
const (
	...
	// objectKeyAsyncFetchJob objectKey value: v1/async-fetch/jwos
	objectKeyAsyncFetchJob objectKeyType = "v1/async-fetch/jwos"
)
