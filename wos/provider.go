...
const (
	accessKeyEnv   = "WOS_ACCESS_KEY_ID"
	securityKeyEnv = "WOS_SECRET_ACCESS_KEY"
...
func (bsp *BasicSecurityProvider) refresh(ak, sk string) {
	bsp.val.Store(securityHolder{ak: strings.TrimSpace(ak), sk: strings.TrimSpace(sk)})
}
